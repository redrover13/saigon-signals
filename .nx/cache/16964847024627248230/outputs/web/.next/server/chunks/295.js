  ...
  (exports.modules = {
    ...
    5614: (e, t, r) => {
      ...
      function N(e) {
        let t,
          ...
          [U, D, I] = (0, d.useReducerWithReduxDevtools)(N);
        (0, o.useEffect)(() => {
          j = null;
        }, []);
        let { canonicalUrl: F } = (0, d.useUnwrapState)(U),
          { searchParams: L, pathname: H } = (0, o.useMemo)(() => {
        ...
        let { pushRef: B } = (0, d.useUnwrapState)(U);
        if (B.mpaNavigation) {
        ...
        return (0, l.jsxs)(l.Fragment, {
          children: [
            (0, l.jsx)(T, {
              appRouterState: (0, d.useUnwrapState)(U),
              sync: I,
            }),
      ...
      function U(e) {
        ...
        return (0, l.jsx)(s.ErrorBoundary, {
          errorComponent: t,
      ...
      class s extends o.default.Component {
        ...
        render() {
          return this.state.error
            ? (0, l.jsxs)(l.Fragment, {
                children: [
                  (0, l.jsx)(d, { error: this.state.error }),
    ...
    6709: (e, t, r) => {
          ...
          if (null === e) {
            let t = (function e(t, r) {
                if (t) {
                  let [n, l] = t,
                    o = 2 === t.length;
                  if ((0, d.matchSegment)(r[0], n) && r[1].hasOwnProperty(l)) {
                    if (o) {
      ...
      function j(e) {
        let {
          ...
          v = (0, o.useContext)(a.LayoutRouterContext);
        if (!v) throw Error("invariant expected layout router to be mounted");
        let { childNodes: j, tree: O, url: S, loading: E } = v,
          M = j.get(t);
        M || ((M = new Map()), j.set(t, M));
        let x = O[1][t][0],
          T = (0, h.getSegmentValue)(x),
          w = [x];
    ...
    6461: (e, t, r) => {
      ...
      function d() {
        ...
        {
          let { bailoutToClientRendering: e } = r(9432);
          e("useSearchParams()");
        }
        return t;
      }
      ...
      function h(e) {
        ...
        return t
          ? (function e(t, r, n, l) {
              ...
              return !d || d.startsWith(u.PAGE_SEGMENT_KEY)
                ? l
                : (l.push(d), e(o, r, !1, l));
            })(t.tree, e)
          : null;
    ...
    1022: (e, t, r) => {
      ...
      function d(e) {
        let { notFound: t, notFoundStyles: r, asNotFound: n, children: u } = e,
          d = (0, a.usePathname)(),
          s = (0, o.useContext)(i.MissingSlotContext);
        return t
          ? (0, l.jsx)(c, {
              pathname: d,
              notFound: t,
        ...
        return (
          (0, o.useEffect)(() => {
            o.default.startTransition(() => {
              (n === u.RedirectType.push ? l.push(t, {}) : l.replace(t, {}),
                r());
            });
          }, [t, n, r, l]),
          null
          ...
          get: function () {
            return function e(t, r, n, u) {
              ...
              if (1 === t.length) {
                let e = a(r, n, t);
                return (
                  (0, o.addRefreshMarkerToActiveParallelSegments)(e, u),
                  e
                );
              }
              let [h, y] = t;
              if (!(0, l.matchSegment)(h, c)) return null;
              if (2 === t.length) i = a(d[y], n, t);
              else if (null === (i = e(t.slice(2), d[y], n, u))) return null;
              let _ = [t[0], { ...d, [y]: i }, s, f];
              return (
                p && (_[4] = !0),
        ...
        Object.defineProperty(t, "clearCacheNodeDataForSegmentPath", {
          ...
          get: function () {
            return function e(t, r, l) {
              ...
              (d && d !== c) || ((d = new Map(c)), t.parallelRoutes.set(a, d));
    ...
    2489: (e, t, r) => {
      ...
      function c(e) {
        ...
        let o = [u(r)],
          a = null != (t = e[1]) ? t : {},
          d = a.children ? c(a.children) : void 0;
        if (void 0 !== d) o.push(d);
        else
        ...
        let r = (function e(t, r) {
          ...
          if (
            n.INTERCEPTION_ROUTE_MARKERS.some(
              (e) => s.startsWith(e) || f.startsWith(e),
            )
          )
            return "";
    ...
    1747: (e, t, r) => {
      ...
      function c(e) {
        ...
        let {
          ...
          v = p ? (0, n.createHrefFromUrl)(p) : _;
        (0, i.addRefreshMarkerToActiveParallelSegments)(c, v);
        let m = new Map();
        (null === f || 0 === f.size) &&
          (0, l.fillLazyItemsTillLeafWithHead)(b, void 0, c, d, h);
        let P = {
          buildId: r,
          tree: c,
          cache: b,
    ...
    6123: (e, t, r) => {
      ...
      async function d(e, t, r, d, s) {
        let f = {
          [n.RSC_HEADER]: "1",
          [n.NEXT_ROUTER_STATE_TREE]: encodeURIComponent(JSON.stringify(t)),
        };
        (s === a.PrefetchKind.AUTO && (f[n.NEXT_ROUTER_PREFETCH_HEADER] = "1"),
          r && (f[n.NEXT_URL] = r));
        let p = (0, u.hexHash)(
          [
          ...
          get: function () {
            return function e(t, r, o, a, u, i) {
              ...
              for (let c in o[1]) {
                    ...
                    ((r =
                      null !== h
                        ? {
                            ...
                            loading: h[3],
                            parallelRoutes: new Map(
                              null == d ? void 0 : d.parallelRoutes,
                            ),
                            lazyDataResolved: !1,
                          }
                        : o && d
                ...
                (y ? y.set(p, d) : t.parallelRoutes.set(c, new Map([[p, d]])),
                  e(d, void 0, s, h, u, i));
              }
            };
          },
        ...
        Object.defineProperty(t, "invalidateCacheBelowFlightSegmentPath", {
          ...
          get: function () {
            return function e(t, r, l) {
              ...
              if (
                ((d && d !== c) ||
                  ((d = new Map(c)), t.parallelRoutes.set(a, d)),
                o)
              ) {
                d.delete(i);
                return;
            ...
            (0, l.fetchServerResponse)(t, n, i, c, r).then((e) => {
              ...
              return (
                r &&
                  ...
                  })({ url: t, nextUrl: i, prefetchCache: d }),
                e
              );
            }),
          ),
            ...
            (t) => {
              ...
              for (let t of r) {
                let r = t.slice(0, -4),
                  n = t.slice(-3)[0],
                  c = ["", ...r],
                  s = (0, o.applyRouterStatePatchToTree)(c, b, n, j);
                if (
                  (null === s &&
                    (s = (0, o.applyRouterStatePatchToTree)(c, E, n, j)),
                  null !== s)
                ) {
                  if ((0, u.isNavigatingToNewRootLayout)(b, s))
                    return _(e, P, j, O);
                  let o = (0, f.createEmptyCacheNode)(),
                    m = !1;
                  for (let e of (S.status !==
                    i.PrefetchCacheEntryStatus.stale || h
                    ? (m = (0, d.applyFlightData)(v, o, t, S))
                    : ((m = (function (e, t, r, n) {
                        let l = !1;
              ...
              return (
                (P.patchedTree = b),
                (P.canonicalUrl = s ? (0, n.createHrefFromUrl)(s) : j),
                (P.pendingPush = O),
    ...
    2910: (e, t, r) => {
      ...
      function h(e, t) {
        ...
        let g = (0, d.createEmptyCacheNode)(),
          ...
          g.lazyData.then(
            async (r) => {
              ...
              for (let r of ((g.lazyData = null), n)) {
                ...
                if (null === i) return (0, s.handleSegmentMismatch)(e, t, n);
                ...
                let f = d ? (0, l.createHrefFromUrl)(d) : void 0;
                d && (h.canonicalUrl = f);
                let [v, m] = r.slice(-2);
                if (null !== v) {
                  let e = v[2];
    ...
    3379: (e, t, r) => {
      ...
      let n = r(3656),
        ...
        h = r(9705),
        y = r(4595),
        { createFromFetch: _, encodeReply: g } = r(8253);
      async function b(e, t, r) {
        let a,
          ...
          s = d.headers.get("x-action-redirect");
        try {
          let e = JSON.parse(
        ...
        return (
          ...
          l.inFlightServerAction.then(
            async (n) => {
              ...
              if (((l.inFlightServerAction = null), v)) {
              ...
              for (let r of b) {
                ...
                let [n] = r,
                  d = (0, i.applyRouterStatePatchToTree)(
                    [""],
                    _,
                    n,
                ...
                if ((0, c.isNavigatingToNewRootLayout)(_, d))
                  return (0, u.handleExternalUrl)(
                    e,
                    l,
                    o,
                ...
                if (null !== m) {
                  ...
                  ((t.rsc = m),
                    (t.prefetchRsc = null),
                    (0, s.fillLazyItemsTillLeafWithHead)(t, void 0, n, p, b),
              ...
              return (r(p), (0, d.handleMutable)(e, l));
            },
            (t) => (n(t), e),
          )
        );
    ...
    8332: (e, t, r) => {
      ...
      function s(e, t) {
        let { serverResponse: r } = t,
          [s, f] = r,
          p = {};
        if (((p.preserveCustomHistoryState = !1), "string" == typeof s))
          return (0, a.handleExternalUrl)(e, p, s, e.pushRef.pendingPush);
        let h = e.tree,
          y = e.cache;
        for (let r of s) {
          let i = r.slice(0, -4),
          ...
          if (null === _) return (0, d.handleSegmentMismatch)(e, t, s);
    ...
    8879: (e, t, r) => {
      ...
      function s({ reason: e, prerenderState: t, pathname: r }) {
        p(t, e, r);
      }
      function f(e, t) {
...
${t}`
    ...
    7918: (e, t, r) => {
      e.exports = r(8307).vendored.contexts.AppRouterContext;
    },
    9060: (e, t, r) => {
      e.exports = r(8307).vendored.contexts.HooksClientContext;
    },
    1794: (e, t, r) => {
      e.exports = r(8307).vendored.contexts.ServerInsertedHtml;
    },
    6533: (e, t, r) => {
      e.exports = r(8307).vendored["react-ssr"].ReactDOM;
    },
    9492: (e, t, r) => {
      e.exports = r(8307).vendored["react-ssr"].ReactJsxRuntime;
    },
    8253: (e, t, r) => {
      e.exports = r(8307).vendored["react-ssr"].ReactServerDOMWebpackClientEdge;
    },
    2841: (e, t, r) => {
      e.exports = r(8307).vendored["react-ssr"].React;
    },
    8703: (e, t) => {
      (Object.defineProperty(t, "__esModule", { value: !0 }),
    ...
    4468: (e, t, r) => {
      ...
      let n = r(4885).createClientModuleProxy;
    },
    5456: (e, t, r) => {
      let { createProxy: n } = r(4468);
      e.exports = n(
        "/workspaces/saigon-signals/node_modules/.pnpm/next@14.2.31_@babel+core@7.28.0_@opentelemetry+api@1.9.0_babel-plugin-macros@3.1.0_reac_d2b92ac87da63ae73308d18d846d5a91/node_modules/next/dist/client/components/app-router.js",
      );
    },
    5693: (e, t, r) => {
      let { createProxy: n } = r(4468);
      e.exports = n(
        "/workspaces/saigon-signals/node_modules/.pnpm/next@14.2.31_@babel+core@7.28.0_@opentelemetry+api@1.9.0_babel-plugin-macros@3.1.0_reac_d2b92ac87da63ae73308d18d846d5a91/node_modules/next/dist/client/components/client-page.js",
      );
    },
    8949: (e, t, r) => {
      let { createProxy: n } = r(4468);
      e.exports = n(
        "/workspaces/saigon-signals/node_modules/.pnpm/next@14.2.31_@babel+core@7.28.0_@opentelemetry+api@1.9.0_babel-plugin-macros@3.1.0_reac_d2b92ac87da63ae73308d18d846d5a91/node_modules/next/dist/client/components/error-boundary.js",
      );
    },
    2700: (e, t, r) => {
      let { createProxy: n } = r(4468);
      e.exports = n(
        "/workspaces/saigon-signals/node_modules/.pnpm/next@14.2.31_@babel+core@7.28.0_@opentelemetry+api@1.9.0_babel-plugin-macros@3.1.0_reac_d2b92ac87da63ae73308d18d846d5a91/node_modules/next/dist/client/components/layout-router.js",
      );
    },
    9709: (e, t, r) => {
      let { createProxy: n } = r(4468);
      e.exports = n(
        "/workspaces/saigon-signals/node_modules/.pnpm/next@14.2.31_@babel+core@7.28.0_@opentelemetry+api@1.9.0_babel-plugin-macros@3.1.0_reac_d2b92ac87da63ae73308d18d846d5a91/node_modules/next/dist/client/components/not-found-boundary.js",
      );
    },
    1476: (e, t, r) => {
      (Object.defineProperty(t, "__esModule", { value: !0 }),
    ...
    8265: (e, t, r) => {
      let { createProxy: n } = r(4468);
      e.exports = n(
        "/workspaces/saigon-signals/node_modules/.pnpm/next@14.2.31_@babel+core@7.28.0_@opentelemetry+api@1.9.0_babel-plugin-macros@3.1.0_reac_d2b92ac87da63ae73308d18d846d5a91/node_modules/next/dist/client/components/render-from-template-context.js",
      );
    },
    8918: (e, t, r) => {
      (Object.defineProperty(t, "__esModule", { value: !0 }),
    ...
    2846: (e, t, r) => {
      (Object.defineProperty(t, "__esModule", { value: !0 }),
        (function (e, t) {
          ...
          createDynamicallyTrackedSearchParams: function () {
            return s.createDynamicallyTrackedSearchParams;
          },
          createUntrackedSearchParams: function () {
    ...
    261: (e, t, r) => {
      e.exports = r(3404).vendored["react-rsc"].ReactDOM;
    },
    2365: (e, t, r) => {
      e.exports = r(3404).vendored["react-rsc"].ReactJsxRuntime;
    },
    4885: (e, t, r) => {
      e.exports = r(3404).vendored["react-rsc"].ReactServerDOMWebpackServerEdge;
    },
    4558: (e, t) => {
      (Object.defineProperty(t, "__esModule", { value: !0 }),
        Object.defineProperty(t, "ReflectAdapter", {
